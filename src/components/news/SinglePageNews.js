            ...
            <Container>
                <div className='grid grid-cols-1 md:grid-cols-12 my-5'>
                    ...
                    <div className='col-span-9'>
                        ...
                        />
                        <div className='flex-1 md:flex justify-between items-center mb-5 p-2 border-b bg-sky-50'>
                            <div className='flex items-center'>
                                <div className='mr-4'>
                                    <img className='rounded-full h-8 md:h-10' src={`https://api.dicebear.com/5.x/initials/svg?seed=Dipu`} alt="Image" />
                                </div>
                                <div className='text-xs md:text-md'>
                                    <p>रवीश पाल सिंह, भोपाल</p>
                                    <p>25 सितंबर 2023,(अपडेटेड 25 सितंबर 2023, 9:40 PM) </p>
                                </div>
                            </div>
                            <div className='flex md:flex-row justify-end space-x-4 md:space-x-8 '>
